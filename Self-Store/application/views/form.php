<div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="<?php echo base_url();?>index.php/reservation/reserveValidation" method="post" novalidate>
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">Customer ID</label>
                                        <input type="text" class="form-control" id="validationCustom01" placeholder="Customer ID" name="custId" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="validationCustom01" placeholder="Unit" name="unit" required max="31">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                                Please provide valid unit number
                                            </div>
                                    </div>
                                </div>
                                <div class="form-row">
